...
<html lang="en">
  ...
  <body
    ...
    <div class="w-full mt-[3rem]">
      <div
        class="w-[8rem] h-[90rem] absolute right-[4rem] -top-[40rem] rotate-90"
        style="z-index: -3;;filter: blur(150px);background: rgb(41, 145, 230);"></div>
      <div
        class="w-[8rem] h-[90rem] left-[4rem] -top-[20rem]  -rotate-45 absolute"
        style="z-index: -3;;filter: blur(150px);background: rgb(0, 140, 255);"></div>
      <div class="  w-full  flex justify-center    top-[4rem]   "
        style="z-index: 3;">

        <div class="relative nav_gation_e456 px-6">

          <div class="flex items-center  justify-center gap-4 ">
            <div
              class="text-white text-sm  flex gap-[3rem] flex-row"
              style="font-family: MuseoModerno, sans-serif; font-weight: 300;">
              <!-- <div class="w-full  h-full  rounded-full absolute " style="z-index: -1;;filter: blur(100px);background: linear-gradient(90deg, rgb(253, 3, 99) 0%, rgb(255, 2, 86) 100%);"></div> -->

              <div class="flex justify-center gap-[1rem] items-center relative">
                <div class="h-full w-[4rem]"><img
                    src="./src/Image/Default_create_a_gradient_color_curve_0_2ee41adb-6b63-4403-8c06-6474f1d5c3e3_0.png"
                    alt></div>
                <div
                  class="relative a_home_link transition duration-1000 ease-in-out">
                  <a href="index.html"
                  ...
                  <div
                    class="absolute bt_home_link transition duration-700 ease-in-out  "></div>
                </div>
                <a href="pricing.html"
                ...
                <div
                  class="vc_gh_tuhss_366sjd relative ease-in transition duration-300 "
                  onmouseover="changeClass()" onmouseout="restoreClass()">
                  <div
                    class="flex items-center relative gap-1 vg_re_4566622_hjt_df ease-in duration-300">
                  ...
                  <div
                    class="absolute h-[8rem] w-full bg-black vv_gg ease-in duration-300 transition"></div>
                  <div class="ribbon"></div>
                  <div
                    class=" gh_tre_hgjt_438996 ease-in duration-300 transition">
        ...
        <div class="mt-[5rem]">
          <div
            ...
            <div class=" h-[26rem] rounded-lg p-4 flex flex-col gap-2"
              style=" box-shadow: 0 0 0 1px var(--themed-border, transparent);">
              <img class="rounded-full w-[4rem] h-[4rem]"
                src="./src/Image/_5b39c928-86c8-4e2b-8344-65faa7c688be.jpg" alt>
              <h1 class="text-white">Sarah Wilson:</h1>
              <p class="text-white">A mobile application development enthusiast,
                Sarah excels in creating responsive and feature-rich mobile
                apps. Her dedication to delivering seamless user experiences
